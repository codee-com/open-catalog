...
| [PWR031](Checks/PWR031/) | Replace call to pow by multiplication, division and/or square root                                                                                                 | ✓ |         | ✓   |         |
...
| [PWR068](Checks/PWR068/) | Encapsulate external procedures within modules to avoid the risks of calling implicit interfaces                                                                   |   | ✓       |     |         |
...
| [PWR072](Checks/PWR072/) | Split the variable initialization from the declaration to prevent the implicit 'save' behavior                                                                     |   | ✓       |     |         |
