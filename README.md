...
| [PWR050](Checks/PWR050/) | Consider applying multithreading parallelism to forall loop                                                                                                        | x |    x    |  x  |
| [PWR051](Checks/PWR051/) | Consider applying multithreading parallelism to scalar reduction loop                                                                                              | x |    x    |  x  |
| [PWR052](Checks/PWR052/) | Consider applying multithreading parallelism to sparse reduction loop                                                                                              | x |    x    |  x  |
| [PWR053](Checks/PWR053/) | Consider applying vectorization to forall loop                                                                                                                     | x |    x    |  x  |
| [PWR054](Checks/PWR054/) | Consider applying vectorization to scalar reduction loop                                                                                                           | x |    x    |  x  |
| [PWR055](Checks/PWR055/) | Consider applying offloading parallelism to forall loop                                                                                                            | x |    x    |  x  |
| [PWR056](Checks/PWR056/) | Consider applying offloading parallelism to scalar reduction loop                                                                                                  | x |    x    |  x  |
| [PWR057](Checks/PWR057/) | Consider applying offloading parallelism to sparse reduction loop                                                                                                  | x |    x    |  x  |
