...
|:------------------------:|:----------------------------------------------------------------------------------------------:|:------------------------:|:-:|:-------:|:---:|:-------:|
| [PWR001](Checks/PWR001/) | Declare global variables as function parameters                                                | correctness, security    | ✓ | ✓       | ✓   |         |
| [PWR002](Checks/PWR002/) | Declare scalar variables in the smallest possible scope                                        | correctness, security    | ✓ |         | ✓   |         |
| [PWR003](Checks/PWR003/) | Explicitly declare pure functions                                                              | modernization, security  | ✓ | ✓       | ✓   |         |
...
| [PWR007](Checks/PWR007/) | Disable implicit declaration of variables                                                      | correctness, security    |   | ✓       |     | ✓[^1]   |
| [PWR008](Checks/PWR008/) | Declare the intent for each procedure parameter                                                | correctness, security    |   | ✓       |     | ✓[^1]   |
...
| [PWR018](Checks/PWR018/) | Call to recursive function within a loop inhibits vectorization                                | optimization, security   | ✓ | ✓       | ✓   |         |
...
| [PWR028](Checks/PWR028/) | Remove pointer increment preventing performance optimization                                   | optimization, security   | ✓ |         | ✓   |         |
| [PWR029](Checks/PWR029/) | Remove integer increment preventing performance optimization                                   | optimization             | ✓ | ✓       | ✓   |         |
| [PWR030](Checks/PWR030/) | Remove pointer assignment preventing performance optimization for perfectly nested loops       | optimization, security   | ✓ | ✓       | ✓   |         |
...
| [PWR063](Checks/PWR063/) | Avoid using legacy Fortran constructs                                                          | modernization, security  |   | ✓       |     |         |
| [PWR068](Checks/PWR068/) | Encapsulate procedures within modules to avoid the risks of calling implicit interfaces        | correctness, security    |   | ✓       |     |         |
| [PWR069](Checks/PWR069/) | Use the keyword only to explicitly state what to import from a module                          | correctness, security    |   | ✓       |     | ✓[^1]   |
| [PWR070](Checks/PWR070/) | Declare array dummy arguments as assumed-shape arrays                                          | correctness, security    |   | ✓       |     |         |
| [PWR071](Checks/PWR071/) | Prefer real(kind=kind_value) for declaring consistent floating types                           | modernization, security  |   | ✓       |     |         |
...
| [PWR073](Checks/PWR073/) | Transform common block into a module for better data encapsulation                             | modernization, security  |   | ✓       |     |         |
| [PWR075](Checks/PWR075/) | Avoid using GNU Fortran extensions                                                             | modernization, security  |   | ✓       |     |         |
| [PWR079](Checks/PWR079/) | Avoid undefined behavior due to uninitialized variables                                        | correctness, security    | ✓ | ✓       | ✓   |         |
